...
export function useKanjiWriter() {
  ...
  var HanziWriter = (function () {
    ...
    const performanceNow =
      (globalObj.performance && (() => globalObj.performance.now())) ||
      (() => Date.now());
    ...
    const ua =
      ((_globalObj$navigator = globalObj.navigator) === null ||
      _globalObj$navigator === void 0
        ? void 0
        : _globalObj$navigator.userAgent) || "";
    const isMsBrowser =
      ua.indexOf("MSIE ") > 0 ||
    ...
    class RenderState {
      ...
      _getActiveMutations() {
        return this._mutationChains.map(
          (chain) => chain._mutations[chain._index]
        );
      }
      ...
      _cancelMutationChain(mutationChain) {
        ...
        (_mutationChain$_resol = mutationChain._resolve) === null ||
        _mutationChain$_resol === void 0
          ? void 0
          : _mutationChain$_resol.call(mutationChain, {
              canceled: true,
            });
        this._mutationChains = this._mutationChains.filter(
          (chain) => chain !== mutationChain
    ...
    const frechetDist = (curve1, curve2) => {
      ...
      const calcVal = (i, j, prevResultsCol, curResultsCol) => {
        ...
        if (i > 0 && j === 0) {
          return Math.max(
            prevResultsCol[0],
            distance(longCurve[i], shortCurve[0])
          );
        }
    ...
    const normalizeCurve = (curve) => {
      ...
      const translatedCurve = outlinedCurve.map((point) =>
        subtract(point, mean)
      );
    ...
    function generateStrokes({ radStrokes, strokes, medians }) {
      const isInRadical = (strokeNum) => {
        ...
        return (
          ((_radStrokes$indexOf =
            radStrokes === null || radStrokes === void 0
              ? void 0
              : radStrokes.indexOf(strokeNum)) !== null &&
          _radStrokes$indexOf !== void 0
            ? _radStrokes$indexOf
            : -1) >= 0
        );
      };
    ...
    const getMatchData = (points, stroke, options) => {
      ...
      const withinDistThresh =
        avgDist <= AVG_DIST_THRESHOLD * distMod * leniency; // short circuit for faster matching
    ...
    class Mutation {
      ...
      cancel(renderState) {
        ...
        (_this$_resolve = this._resolve) === null || _this$_resolve === void 0
          ? void 0
          : _this$_resolve.call(this);
        this._resolve = undefined;
    ...
    function getPartialValues(startValues, endValues, progress) {
      ...
      for (const key in endValues) {
        ...
        const startValue =
          startValues === null || startValues === void 0
            ? void 0
            : startValues[key];
    ...
    const updateColor = (colorName, colorVal, duration) => {
      return [
        new Mutation(`options.${colorName}`, colorVal, {
          duration,
        }),
      ];
    };
    ...
    class Quiz {
      ...
      continueUserStroke(externalPoint) {
        ...
        return this._renderState.run(
          updateUserStroke(this._userStroke.id, nextPoints)
        );
      }
      ...
      endUserStroke() {
        ...
        this._renderState.run(
          removeUserStroke(
            this._userStroke.id,
            (_this$_options$drawin = this._options.drawingFadeDuration) !==
              null && _this$_options$drawin !== void 0
              ? _this$_options$drawin
              : 300
          )
        ...
        const isAccepted =
          isMatch || (meta.isStrokeBackwards && acceptBackwardsStrokes);
      ...
      _handleSuccess(meta) {
        ...
        onCorrectStroke === null || onCorrectStroke === void 0
          ? void 0
          : onCorrectStroke({
              ...this._getStrokeData({
                isCorrect: true,
      ...
      _handleFailure(meta) {
        ...
        (_this$_options$onMist = (_this$_options = this._options).onMistake) ===
          null || _this$_options$onMist === void 0
          ? void 0
          : _this$_options$onMist.call(
              _this$_options,
              this._getStrokeData({
                isCorrect: false,
                meta,
    ...
    function removeElm(elm) {
      ...
      elm === null || elm === void 0
        ? void 0
        : (_elm$parentNode = elm.parentNode) === null ||
          _elm$parentNode === void 0
        ? void 0
    ...
    class StrokeRendererBase {
      constructor(stroke) {
        this.stroke = stroke;
        this._pathLength =
          stroke.getLength() + StrokeRendererBase.STROKE_WIDTH / 2;
      }
      ...
      _getColor({ strokeColor, radicalColor }) {
        return radicalColor && this.stroke.isInRadical
          ? radicalColor
          : strokeColor;
      }
    }
    ...
    class StrokeRenderer extends StrokeRendererBase {
      ...
      mount(target) {
        ...
        const extendedMaskPoints = extendStart(
          this.stroke.points,
          STROKE_WIDTH / 2
        );
      ...
      render(props) {
        ...
        if (
          ...
          ((_this$_oldProps = this._oldProps) === null ||
          _this$_oldProps === void 0
            ? void 0
            : _this$_oldProps.displayPortion)
        ) {
          this._animationPath.style.strokeDashoffset =
            this._getStrokeDashoffset(props.displayPortion).toString();
        }
        ...
        if (
          props.opacity !==
          ((_this$_oldProps2 = this._oldProps) === null ||
          _this$_oldProps2 === void 0
            ? void 0
            : _this$_oldProps2.opacity)
        ) {
    ...
    class CharacterRenderer {
      constructor(character) {
        ...
        this._strokeRenderers = character.strokes.map(
          (stroke) => new StrokeRenderer(stroke)
        );
      }
      ...
      render(props) {
        ...
        if (
          colorsChanged ||
          strokes !==
            ((_this$_oldProps3 = this._oldProps) === null ||
            _this$_oldProps3 === void 0
              ? void 0
              : _this$_oldProps3.strokes)
        ) {
          for (let i = 0; i < this._strokeRenderers.length; i++) {
            ...
            if (
              !colorsChanged &&
              (_this$_oldProps4 = this._oldProps) !== null &&
              _this$_oldProps4 !== void 0 &&
              _this$_oldProps4.strokes &&
      ...
      render(props) {
        ...
        if (
          props.strokeColor !==
            ...
            _this$_oldProps === void 0
              ? void 0
              : _this$_oldProps.strokeColor) ||
          props.strokeWidth !==
            ((_this$_oldProps2 = this._oldProps) === null ||
            _this$_oldProps2 === void 0
              ? void 0
              : _this$_oldProps2.strokeWidth)
        ) {
    ...
    class HanziWriterRenderer {
      ...
      mount(target) {
        ...
        attr(
          group,
          "transform",
          `translate(${xOffset}, ${height - yOffset}) scale(${scale}, ${
            -1 * scale
          })`
        );
      ...
      render(props) {
        ...
        for (const userStrokeId in this._userStrokeRenderers) {
          if (!userStrokes[userStrokeId]) {
            ...
            (_this$_userStrokeRend =
              this._userStrokeRenderers[userStrokeId]) === null ||
            _this$_userStrokeRend === void 0
              ? void 0
              : _this$_userStrokeRend.destroy();
        ...
        if (this._pt) {
          ...
          if ("getScreenCTM" in this.node) {
            ...
            const localPt = this._pt.matrixTransform(
              (_this$node$getScreenC = this.node.getScreenCTM()) === null ||
                _this$node$getScreenC === void 0
                ? void 0
                : _this$node$getScreenC.inverse()
            );
      ...
      _getTouchPoint(evt) {
        if (this._pt) {
          ...
          if ("getScreenCTM" in this.node) {
            ...
            const localPt = this._pt.matrixTransform(
              (_this$node$getScreenC2 = this.node.getScreenCTM()) === null ||
                _this$node$getScreenC2 === void 0
                ? void 0
                : _this$node$getScreenC2.inverse()
            );
    ...
    class StrokeRenderer$1 extends StrokeRendererBase {
      ...
      render(ctx, props) {
        ...
        if (this._path2D) {
          ...
          (_this$_pathCmd = this._pathCmd) === null || _this$_pathCmd === void 0
            ? void 0
            : _this$_pathCmd.call(this, ctx); // wechat bugs out if the clip path isn't stroked or filled
    ...
    class CharacterRenderer$1 {
      constructor(character) {
        this._strokeRenderers = character.strokes.map(
          (stroke) => new StrokeRenderer$1(stroke)
        );
      }
      ...
      _debouncedLoad(char, count) {
        ...
        const wrappedResolve = (data) => {
          if (count === this._loadCounter) {
            ...
            (_this$_resolve = this._resolve) === null ||
            _this$_resolve === void 0
              ? void 0
              : _this$_resolve.call(this, data);
          }
        };
        ...
        const wrappedReject = (reason) => {
          if (count === this._loadCounter) {
            ...
            (_this$_reject = this._reject) === null || _this$_reject === void 0
              ? void 0
              : _this$_reject.call(this, reason);
          }
        };
      ...
      _setupLoadingPromise() {
        return new Promise((resolve, reject) => {
          ...
          .then((data) => {
            ...
            this._isLoading = false;
            (_this$_options$onLoad = (_this$_options = this._options)
              .onLoadCharDataSuccess) === null ||
            _this$_options$onLoad === void 0
              ? void 0
              : _this$_options$onLoad.call(_this$_options, data);
            return data;
          })
          .catch((reason) => {
            this._isLoading = false;
    ...
    class HanziWriter {
      constructor(element, options = {}) {
        ...
        this._renderer = {
          HanziWriterRenderer:
            rendererOverride.HanziWriterRenderer || HanziWriterRenderer,
          createRenderTarget:
            rendererOverride.createRenderTarget || createRenderTarget,
      ...
      static loadCharacterData(character, options = {}) {
        const loadingManager = (() => {
          ...
          if (
            (_loadingManager === null || _loadingManager === void 0
              ? void 0
              : _loadingManager._loadingChar) === character &&
      ...
      showCharacter(options = {}) {
        ...
        return this._withData(() => {
          ...
          return (_this$_renderState = this._renderState) === null ||
            _this$_renderState === void 0
            ? void 0
            : _this$_renderState
                .run(
                  showCharacter(
                ...
                .then((res) => {
                  ...
                  _options$onComplete === void 0
                    ? void 0
                    : _options$onComplete.call(options, res);
                  return res;
                });
        });
      }
      ...
      hideCharacter(options = {}) {
        ...
        return this._withData(() => {
          ...
          return (_this$_renderState2 = this._renderState) === null ||
            _this$_renderState2 === void 0
            ? void 0
            : _this$_renderState2
                .run(
                  hideCharacter(
                ...
                .then((res) => {
                  ...
                  (_options$onComplete2 = options.onComplete) === null ||
                  _options$onComplete2 === void 0
                    ? void 0
                    : _options$onComplete2.call(options, res);
                  return res;
                });
        });
      }
      ...
      animateCharacter(options = {}) {
        ...
        return this._withData(() => {
          ...
          return (_this$_renderState3 = this._renderState) === null ||
            _this$_renderState3 === void 0
            ? void 0
            : _this$_renderState3
                .run(
                  animateCharacter(
                ...
                .then((res) => {
                  ...
                  (_options$onComplete3 = options.onComplete) === null ||
                  _options$onComplete3 === void 0
                    ? void 0
                    : _options$onComplete3.call(options, res);
                  return res;
                });
        });
      }
      ...
      animateStroke(strokeNum, options = {}) {
        ...
        return this._withData(() => {
          ...
          return (_this$_renderState4 = this._renderState) === null ||
            _this$_renderState4 === void 0
            ? void 0
            : _this$_renderState4
                .run(
                  animateSingleStroke(
                ...
                .then((res) => {
                  ...
                  (_options$onComplete4 = options.onComplete) === null ||
                  _options$onComplete4 === void 0
                    ? void 0
                    : _options$onComplete4.call(options, res);
                  return res;
                });
        });
      }
        ...
        const promise = () => {
          ...
          return this._renderState
            ...
            .then((res) => {
              ...
              (_options$onComplete5 = options.onComplete) === null ||
              _options$onComplete5 === void 0
                ? void 0
                : _options$onComplete5.call(options, res);
              return res;
            });
        };
      ...
      pauseAnimation() {
        return this._withData(() => {
          ...
          return (_this$_renderState5 = this._renderState) === null ||
            _this$_renderState5 === void 0
            ? void 0
            : _this$_renderState5.pauseAll();
        });
      }
      ...
      resumeAnimation() {
        return this._withData(() => {
          ...
          return (_this$_renderState6 = this._renderState) === null ||
            _this$_renderState6 === void 0
            ? void 0
            : _this$_renderState6.resumeAll();
        });
      }
      ...
      showOutline(options = {}) {
        ...
        return this._withData(() => {
          ...
          return (_this$_renderState7 = this._renderState) === null ||
            _this$_renderState7 === void 0
            ? void 0
            : _this$_renderState7
                .run(
                  showCharacter(
                ...
                .then((res) => {
                  ...
                  (_options$onComplete6 = options.onComplete) === null ||
                  _options$onComplete6 === void 0
                    ? void 0
                    : _options$onComplete6.call(options, res);
                  return res;
                });
        });
      }
      ...
      hideOutline(options = {}) {
        ...
        return this._withData(() => {
          ...
          return (_this$_renderState8 = this._renderState) === null ||
            _this$_renderState8 === void 0
            ? void 0
            : _this$_renderState8
                .run(
                  hideCharacter(
                ...
                .then((res) => {
                  ...
                  (_options$onComplete7 = options.onComplete) === null ||
                  _options$onComplete7 === void 0
                    ? void 0
                    : _options$onComplete7.call(options, res);
                  return res;
                });
        });
      }
      ...
      updateColor(colorName, colorVal, options = {}) {
        ...
        mutations = mutations.concat(
          updateColor(colorName, mappedColor, duration)
        ...
        return this._withData(() => {
          ...
          return (_this$_renderState9 = this._renderState) === null ||
            _this$_renderState9 === void 0
            ? void 0
            : _this$_renderState9.run(mutations).then((res) => {
                var _options$onComplete8;

                (_options$onComplete8 = options.onComplete) === null ||
                _options$onComplete8 === void 0
                  ? void 0
                  : _options$onComplete8.call(options, res);
                return res;
              });
        });
      }
      ...
      quiz(quizOptions = {}) {
        return this._withData(async () => {
          if (this._character && this._renderState && this._positioner) {
            ...
            this._options = { ...this._options, ...quizOptions };
        ...
        this._withDataPromise = this._loadingManager
          ...
          .then((pathStrings) => {
            ...
            this._renderState = new RenderState(
              this._character,
              this._options,
              (nextState) => hanziWriterRenderer.render(nextState)
            );
      ...
      _assignOptions(options) {
        const mergedOptions = { ...defaultOptions, ...options }; // backfill strokeAnimationSpeed if deprecated strokeAnimationDuration is provided instead

        if (options.strokeAnimationDuration && !options.strokeAnimationSpeed) {
          mergedOptions.strokeAnimationSpeed =
            500 / options.strokeAnimationDuration;
        }
      ...
      _setupListeners() {
        ...
        this.target.addPointerEndListener(() => {
          ...
          (_this$_quiz = this._quiz) === null || _this$_quiz === void 0
            ? void 0
            : _this$_quiz.endUserStroke();
        });
      }
    }
